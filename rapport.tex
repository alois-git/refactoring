...
\begin{document}
  ...
  \begin{myfig}{typegraphe}{graphe de type}
    \includegraphics[width=\textwidth]{typegraphe.png}
  \end{myfig}
  ...
  \begin{myfig}{typedgraphe}{graphe de programme}
    \includegraphics[width=\textwidth]{typedgraphe.png}
  \end{myfig}
  ...
  \begin{myfig}{grapheExpression}{graphe d'expression}
    \includegraphics{grapheExpression.png}
  \end{myfig}
  ...
  \begin{myfig}{sousgraphe}{$\underset{out}{Emb} ~ et ~ $\underset{out}{Emb}}
    \tikzset{>=latex}
    \begin{tikzpicture}
      \node[] at (1,5) {L};
